  ...
  return (
    <>
      <div className="flex gap-y-2 lg:gap-0 relative w-full flex-col lg:flex-row overflow-x-hidden">
        ...
        {index % 2 !== 0 && (
          <>
            <div className="flex flex-col py-6 lg:justify-center lg:px-4 order-2 lg:order-none items-center lg:border-r-2 lg:border-dashed w-full lg:w-1/2">
            <h1 className="font-bold uppercase text-4xl">{item.title}</h1>
            <h3 className="font-bold uppercase text-xl">{item.role}</h3>
                <p className="py-2">{item.description}</p>
                <div className="flex lg:px-4 flex-wrap gap-2">
            ...
            <div onClick={() => OpenLink(item.url)} className="flex py-6 order-1 lg:order-none lg:px-2 justify-end items-center w-full lg:w-1/2">
